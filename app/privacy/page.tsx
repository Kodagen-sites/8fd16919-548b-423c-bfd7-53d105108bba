  ...
  return (
    ...
    <main className="mx-auto max-w-3xl px-5 pb-24 pt-32 md:px-8 md:pt-40 text-white">
      ...
      <div className="mt-12 space-y-8 leading-relaxed [&_h2]:text-xl [&_h2]:font-medium [&_h2]:mt-10 [&_h2]:mb-3 [&_h2]:text-white [&_p]:text-white/75 [&_li]:text-white/75 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:space-y-1">
        <p>
          {company} (&ldquo;we&rdquo;, &ldquo;us&rdquo;, &ldquo;our&rdquo;) respects your privacy. This policy explains
          what information we collect, how we use it, and the choices you have. By using this website you agree to this
          policy.
        </p>
        ...
        <div>
          ...
          <ul>
            <li><strong>Information you provide</strong> — name, email, phone, delivery address, and any message you send through our contact, enquiry, or checkout forms.</li>
            <li><strong>Order &amp; payment data</strong> — items ordered and details needed to fulfil and deliver your order. Card payments are handled by our payment processor; we do not store full card numbers.</li>
            ...
            <li><strong>Cookies</strong> — small files that keep the site and cart working and help us understand how it is used. You can disable cookies in your browser.</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul>
            ...
            <li>To improve our website, menu, and offerings.</li>
        ...
        <div>
          ...
          <p>
            We do not sell your personal information. We share it only with service providers who help us operate this
            website and fulfil orders (such as hosting, payment, delivery, and analytics providers), and only as needed
            for them to perform their work, or where required by law.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            or to object to certain processing. To exercise these rights, contact us at{" "}
        ...
        <div>
          ...
          <p>
            ...
            transmission over the internet is fully secure, so we cannot guarantee absolute security.
          </p>
        </div>
        ...
        <div>
          ...
          <p>
            ...
            <a className="underline text-primary" href={`mailto:${email}`}>{email}</a>. We operate in {jurisdiction}.
          </p>
        </div>
      </div>
    </main>

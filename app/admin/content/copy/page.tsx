...
export default async function CopyEditorListPage() {
  ...
  const overridesMap = new Map<string, { value: string; updated: string }>(
    (overrides ?? []).map((o: any) => [o.copy_key as string, { value: o.copy_value as string, updated: o.updated_at as string }])
  );
